...
function mattrad_change_post_label() {
    global $menu;
    global $submenu;
    $menu[5][0] = 'News';
...
function mattrad_change_post_object() {
...
add_action( 'admin_menu', 'mattrad_change_post_label' );
add_action( 'init', 'mattrad_change_post_object' );